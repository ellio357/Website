CREATE TABLE IF NOT EXISTS `skills` (
  ...
  `experience_id` int(11)         NOT NULL         COMMENT 'The experience id that references experiences.experience_id',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='Skills table';