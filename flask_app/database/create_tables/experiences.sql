CREATE TABLE IF NOT EXISTS `experiences` (
  ...
  `position_id`   int(11)         NOT NULL         COMMENT 'The position id that references positions.position_id',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='Experiences table';